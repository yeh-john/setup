...
then
   ...
   sleep 2
   wget https://github.com/catchthatrabbit/coreminer/releases/download/v0.19.71/coreminer-linux-arm64.tar.gz
   sleep 2
   tar -xzvf ./coreminer-linux-arm64.tar.gz
   sleep 2
   rm -rf ./coreminer-linux-arm64.tar.gz
   sleep 2
